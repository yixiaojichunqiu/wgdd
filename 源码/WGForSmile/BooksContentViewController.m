...
@interface BooksContentViewController ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource>
@end

@implementation BooksContentViewController
...
-(void)createUI
{
    ...
    BooksContentDataViewController *dvc = [self dataViewControllerAtIndex:0];
...
-(BooksContentDataViewController *)dataViewControllerAtIndex:(NSUInteger)index
{
    BooksContentDataViewController *dvc = [[BooksContentDataViewController alloc]init];
    ...
    dvc.content=self.content;
    return dvc;
}

// 返回当前viewController数据在数组中所处位置
-(NSUInteger)indexOfViewController:(BooksContentDataViewController *)dvc
{
...
-(UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController
{
    ...
    NSUInteger index = [self indexOfViewController:(BooksContentDataViewController *)viewController];
    // index为0表示已经翻到最前页
